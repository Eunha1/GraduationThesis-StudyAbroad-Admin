...
function EditMenu() {
  ...
  const listBreadcrumb = [
    ...
    {
      isCurrentPage: true,
      src: `/page-manager/edit-menu/${menu_id}`,
  ...
  const getMenuById = async () => {
    const data = await getRequest(`/api/menu/get-menu/${menu_id}`);
    formik.setFieldValue('name', data.data.name);
    if (data.data.menu_parent) {
      formik.setFieldValue('menu_parent', data.data.menu_parent._id);
    }
